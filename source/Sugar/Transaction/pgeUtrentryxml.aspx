    ...
    <script type="text/javascript">
        ...
        function validation() {
            ...
            XML = XML + "<UtrHead " + DOCNOC + " bank_ac='" + bank_ac + "' mill_code='" + mill_code + "' amount='" + Amount + "' utr_no='" + utr_no + "' narration_header='" + narration_header + "' " +
                ...
                "" + insertrecord + " IsSave='" + issave + "' Lott_No='0' utrid='" + utId + "' ba='" + bankid + "' mc='" + millid + "' Processed='" + Processed + "' SelectedBank='" + SelectedBank + "' isPaymentDone='" + isPaymentDone + "' EntryType='" + EntryType + "' PaymentType='" + PaymentType + "'>";
