...
public partial class Sugar_Report_rptSelfBalanceGroupWice : System.Web.UI.Page
{
    int company_code;
    int year_code;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        rpt.Load(Server.MapPath("~/Sugar/Report/cryselfBalanceGroupWice.rpt"));
        rpt.SetDataSource(dt);

        cryselfBalanceGroupWice.ReportSource = rpt;
        cryselfBalanceGroupWice.RefreshReport();
    ...
    {
        this.cryselfBalanceGroupWice.ReportSource = null;

        cryselfBalanceGroupWice.Dispose();
