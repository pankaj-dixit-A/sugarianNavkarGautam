...
public partial class Sugar_pgeDeliveryOrderForGSTxmlNew : System.Web.UI.Page
{
                    ...
                    if (doauth == "1")
                    {
                        ...
                        if (Action == "1")
                        {
                            ...
                            { 
                                    ...
                                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "showsms", "javascript:showsmspopup( doc = '" + txtdoc_no.Text + "');", true);
    ...
    private bool fetchRecord(string qry)
    {
        try
        {
          ...
          + " and Company_Code=" + Session["Company_Code"].ToString() + "");
            ...
            {
                double amt = Convert.ToDouble(str.Replace(" Debit", ""));
                ...
                string Bal_Limit = clsCommon.getString("select isnull(Bal_Limit,0) as acid from nt_1_accountmaster where Ac_Code='" + txtSaleBillTo.Text + "' and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + "");

                double bylimitAmount = Convert.ToDouble(Bal_Limit)-amt;

                if (bylimt == "Y" && bylimitAmount <= 0)
                {
                    btnOurDO.Enabled = false;
                }
                else
                ...
                lblSaleBillToLedgerByBalance.Text = lblSaleBillToLedgerByBalance.Text + "(" + bylimitAmount + ")";
            }
            ...
            if (strTextBox == "txtSaleBillTo")
            {
                ...
                if (txtSaleBillTo.Text != string.Empty)
                {
                    ...
                    else
                    {
                        ...
                        string Insurance = clsCommon.getString("select Insurance from qrymstaccountmaster where Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Ac_Code=" + txtSaleBillTo.Text + "");
                        double textInsurance = 0.00;
                        if (txtInsurance.Text == "") {
                            txtInsurance.Text = "0";
                        }
                        textInsurance =  Convert.ToDouble(txtInsurance.Text);
                        if (textInsurance > 0)
                        {
                            drpInsured.SelectedValue = "Y";
                        }
    ...
    protected void btngenratesalebill_Click(object sender, EventArgs e)
    {
        ...
        string BillNumber = clsCommon.getString(qry);
        ...
        if (BillNumber == "0")
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "SuccessMessage", "alert('this bill allredy generated Sale Bill No: " + BillNumber + "!'); window.location.reload();", true);
