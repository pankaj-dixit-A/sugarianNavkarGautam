...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            console.log(Outword_Date);
            // Outword_Date = Outword_Date.slice(6, 11) + Outword_Date.slice(3, 5) + "/" + Outword_Date.slice(0, 2); 
            //debugger;
            //if (DocDates < Outword_Date) {
            ...
            if (AUTO_VOUCHER == "YES") {
                if (DESP_TYPE == "DI" && (txtGETPASS_CODE == SELFAC || PDS == "P")) {
                    if (autopurchasebill == "Y") {
                        ...
                        var CreditNarration = document.getElementById("<%= hdnfmillshortname.ClientID %>").value + "L:" + TRUCK_NO + "G:" + txtGRADE + " " + txtquantal + "R:" + Purchase_Rate + " Bill No:" + MillInvoiceno;
                        var DebitNarration = document.getElementById("<%= hdnfmillshortname.ClientID %>").value + " " + PaymentShort + "L:" + TRUCK_NO + "G:" + txtGRADE + " " + txtquantal + "R:" + Purchase_Rate + " Bill No:" + MillInvoiceno;
                        var TCSNarration = 'TCS' + " " + PaymentShort + " " + purcDoc_No + " Bill No:" + MillInvoiceno;
                        var TDSNarration = 'TDS' + " " + PaymentShort + " " + purcDoc_No + " Bill No:" + MillInvoiceno;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (
                        ...
                        var transportmobile = obj[0].transportWabno;
                        if (transportmobile == "") {
                            transportmobile = 0;
                        }
                        ...
                        var tenderdomobileno = obj[0].tenderdoWano;
                        if (tenderdomobileno == "") {
                            tenderdomobileno = 0;
                        }
                        var PaymenttoMobileNo = obj[0].PaymenttoWaNo;
                        if (PaymenttoMobileNo == "") {
                            PaymenttoMobileNo = 0;
                        }

                        var DO = obj[0].DO;Payment_To
                        var Payment_To = obj[0].Payment_To;

                        debugger;
                        var brokermobile = obj[0].brokermobno;
                        var salebilltoMobile = obj[0].salebillWabno;
                        if (salebilltoMobile == "") {
                            salebilltoMobile = 0;
                        }

                        var shippedTo_Mobileno = obj[0].shiptoWabno;
                        if (shippedTo_Mobileno == "") {
                            shippedTo_Mobileno = 0;
                        }
                        var BP_WhatsappNo = obj[0].cashdiifWabno;
                        if (BP_WhatsappNo == "") {
                            BP_WhatsappNo = 0;
                        }
                        ...
                        if (brokermobile == '') {
                            ...
                            if (salebilltoMobile == shippedTo_Mobileno) {
                                sms1mobile = "'" + salebilltoMobile + "','" + BP_WhatsappNo + "'";
                            }
                         
                             if (salebilltoMobile == BP_WhatsappNo) {
                                sms1mobile = "'" + salebilltoMobile + "','" + shippedTo_Mobileno + "'";
                            } 
                             if (shippedTo_Mobileno == BP_WhatsappNo) {
                                sms1mobile = "'" + salebilltoMobile + "','" + shippedTo_Mobileno + "'";
                            }
                             if (salebilltoMobile == shippedTo_Mobileno && salebilltoMobile == BP_WhatsappNo && shippedTo_Mobileno == BP_WhatsappNo) {
                                sms1mobile = " '" + salebilltoMobile + "'";
                                //sms1mobile = getpassmobile, + shippedTo_Mobileno;
                            }
                             if (salebilltoMobile == shippedTo_Mobileno && salebilltoMobile == BP_WhatsappNo && shippedTo_Mobileno == BP_WhatsappNo &&
                                 shippedTo_Mobileno == transportmobile && salebilltoMobile == transportmobile && BP_WhatsappNo == transportmobile) {
                                 partysmsmobile = " '" + salebilltoMobile + "'";
                                 //sms1mobile = getpassmobile, + shippedTo_Mobileno;
                             }
                             if (transportmobile == '' && transportmobile == 0) {
                                 partysmsmobile = " '" + sms1mobile + "'";
                             }  
                                 partysmsmobile = " '" + sms1mobile + "','" + transportmobile + "'";
                              

                             if (DO == '2' && Payment_To == '2') {

                                 txtmillmobile = " '" + millmobile + "'"; 
                             }
                             //if (PaymenttoMobileNo == millmobile) {
                             //    txtmillmobile = " '" + millmobile + "','" + tenderdomobileno + "'";
                             //}
                             if (tenderdomobileno == PaymenttoMobileNo && tenderdomobileno == millmobile && PaymenttoMobileNo == millmobile) {
                             ...
                             txtmillmobile = " '" + millmobile + "','" + tenderdomobileno + "','" + PaymenttoMobileNo + "'";
                        }
                        ...
                        //mill
                        txtmillmobile = txtmillmobile.replace(/[']+/g, '');
                        $('#<%=millsms.ClientID %>').html(millsms);
                        $('#<%=millname.ClientID %>').html(millname);
                        $('#millmobile').val(txtmillmobile);
                        ...
                        partysmsmobile = partysmsmobile.replace(/[']+/g, '');
                        $('#<%=transportsms.ClientID %>').html(transportsms);
                        $('#<%=party.ClientID %>').html(voucherbyname);
                        $('#txtpartymobile').val(partysmsmobile);
                    }
